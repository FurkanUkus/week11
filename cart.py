class ShoppingCart:
    ...
    def add_item(self, name: str, price: float, quantity: int = 1) -> None:
        ...
        if name in self._items:
            # FIX: Eski miktarın üzerine yazmak yerine mevcut miktara ekleme yapıldı.
    ...
    def apply_discount(self, code: str) -> None:
        ...
        # FIX: Sınır değerlerini de kapsayacak şekilde >= kullanıldı.
    ...
    def get_total(self) -> float:
        ...
        if self._discount["type"] == "percent":
            # FIX: // (integer division) yerine / (float division) kullanılarak yüzde hesabı düzeltildi.
    ...
    def get_item_count(self) -> int:
        ...
        """
        # FIX: NotImplementedError kaldırılarak fonksiyon işlevsel hale getirildi.
